...
void Robot::resetKalmanFilter() {
   ...
   // Initialize state covariance matrix
    ...
    _Phat(0,0) = 100*0.0001;     // Fill the initial covariance matrix, you can change this according to your experiments
    _Phat(1,1) = 100*0.0001;
    _Phat(2,2) = 4*0.03;    // 10 graden fout
